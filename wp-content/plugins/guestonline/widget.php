	...
	*/
	class Instabook_Bookings_Widget extends WP_Widget
	{
		function __construct()
		{
			...
			parent::__construct(PLUGIN_SLUG, __(PLUGIN_NAME, 'bookings'), $widget_opts);
...
?>			
        ...
        <br/>
        <input type="radio" name="<?php echo $this->get_field_name('widget_type_display'); ?>" value="2"  <?php if ($widget_type_display=="2") echo "checked"; ?> > Iframe </input>
			</p>
...
<?php							
		...
		function init_plugin_constants()
		{
			...
			if(!defined('PLUGIN_NAME'))
				define ('PLUGIN_NAME', 'Guestonline widget');
	...
	class Instabook_Subscribe_Newsletters_Widget extends WP_Widget
	{
		function __construct()
		{
			...
			parent::__construct('wp-instabook-subscribe', __('Instabook subscription', 'newsletters'), $widget_opts);
